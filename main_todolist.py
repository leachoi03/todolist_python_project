...
######### 알람 기능 ##########
time_format=tk.Label(alarm_tab, text= "< 0시부터 24시까지 설정 가능 >", font=("Arial",15)).place(x=100,y=200)
time_format_plus=tk.Label(alarm_tab, text= "ex. 오후 8시 -> 20시", font=("Arial",15)).place(x=100,y=250)
addTime = tk.Label(alarm_tab, text = "Hour    Min    Sec", font=("Helevetica",15)).place(x = 250, y=50)
setYourAlarm = tk.Label(alarm_tab, text = "알람 시간 설정 : ", relief = "solid",font=("Helevetica",15,"bold")).place(x=80, y=80)
 
hour = StringVar()
min = StringVar()
sec = StringVar()
 
hourTime= tk.Entry(alarm_tab, textvariable = hour, bg = "yellow", width = 4, font=(20)).place(x=250,y=80)
minTime= tk.Entry(alarm_tab, textvariable = min, bg = "yellow", width = 4, font=(20)).place(x=310,y=80)
secTime = tk.Entry(alarm_tab, textvariable = sec, bg = "yellow", width = 4, font=(20)).place(x=370,y=80)
 
submit = tk.Button(alarm_tab, text = "Set Your Alarm", fg="Black", bg="#D4AC0D", width = 30, 
                                                        command = get_alarm_time, font=("Arial",15)).place(x=80,y=120)
